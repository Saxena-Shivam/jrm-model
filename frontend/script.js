    ...
    { id: 'ZC6685', name: 'COCO PARBATSAR', risk: '' }
        ...
        function populateDestinations(terminal) {
            ...
            if (destinations[terminal]) {
                ...
                document.getElementById('totalStations').textContent = destinations[terminal].length;
            }
        }
        ...
        function showDestination() {
            ...
            const terminalName = terminal.charAt(0).toUpperCase() + terminal.slice(1) + ' Terminal';
        ...
        function handleIframeLoad(iframe) {
            ...
            try {
                ...
                console.log('Iframe loaded but content access restricted (normal for cross-origin)');
            }
        }
